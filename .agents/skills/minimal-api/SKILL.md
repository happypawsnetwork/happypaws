...
.NET 10 has built-in OpenAPI support for generating the spec. We use `Scalar.AspNetCore` for rendering the documentation UI instead of Swashbuckle/Swagger UI. 
The documentation UI is hidden behind a feature flag in production.
